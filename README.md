...
Thanks to overshard/docker-teamspeak for allmost everything. Uses debian:jessie instead of ubuntu.
...
docker-teamspeak and TeamSpeak itself.
    ...
    git clone https://github.com/mdeheij/docker-teamspeak
    cd docker-teamspeak
    docker build -t mdeheij/teamspeak .
...
`mkdir -p /mnt/teamspeak`.
    ...
    sudo docker run -d=true -p=9987:9987/udp -p=10011:10011 -p=30033:30033 -v=/mnt/teamspeak:/data mdeheij/teamspeak /start
...
### Notes on the run command
 ...
 + `mdeheij/teamspeak` is simply what I called my docker build of this image
